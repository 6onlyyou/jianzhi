...
var numpay = ""
    override fun initViewParams() {
        ...
        datas.add(Pickers("50", "1"))
        datas.add(Pickers("100", "2"))
        datas.add(Pickers("500", "3"))
        datas.add(Pickers("1000", "4"))
        datas.add(Pickers("5000", "5"))
        datas.add(Pickers("10000", "6"))
        datas.add(Pickers("50000", "7"))
